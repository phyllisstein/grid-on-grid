...
var ReactFiberClassComponent = function (legacyContext, scheduleWork, computeExpirationForFiber, memoizeProps, memoizeState) {
  ...
  function checkShouldComponentUpdate(workInProgress, oldProps, newProps, oldState, newState, newContext) {
    if (workInProgress.updateQueue !== null && workInProgress.updateQueue.hasForceUpdate) {
...
var ReactFiberUnwindWork = function (hostContext, legacyContext, newContext, scheduleWork, markLegacyErrorBoundaryAsFailed, isAlreadyFailedLegacyErrorBoundary, onUncaughtError) {
  ...
  function throwException(returnFiber, sourceFiber, rawValue, renderExpirationTime) {
...
var ReactFiberScheduler = function (config) {
  ...
  var _ReactFiberUnwindWork = ReactFiberUnwindWork(hostContext, legacyContext, newContext, scheduleWork, markLegacyErrorBoundaryAsFailed, isAlreadyFailedLegacyErrorBoundary, onUncaughtError),
  ...
  function renderRoot(root, expirationTime, isAsync) {
    ...
    do {
      try {
        ...
        throwException(returnFiber, sourceFiber, thrownValue, nextRenderExpirationTime);
